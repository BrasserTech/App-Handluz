# AGENTS.md - App Handluz

## Regras de Colaboracao (Obrigatorio)

- **Idioma:** Todo codigo e chat em **portugues do Brasil**
- **Commit:** Jamais faca/solicite para ser feito commit sem ser solicitado de forma explicita. Quando for requisitado para commitar, deve comitar o que tem pendente e fazer o comentario do que foi feito de alteracoes. Esse comentario deve ficar tambem no corpo do commit, nao apenas na resposta do chat. Os commits não devem ser feitos em sandbox
